...
P2.44 不通过扩大 prompt、top-k 或上下文上限修补该问题。后续 P2.45 已完成“权威当前状态锚点 + 来源多样性 + 分区预算”设计；P2.45a 已实现快照与锚点读取基础，P2.45b 已实现纯候选选择和分区预算，但尚未接入生产检索。见 `docs/development-context-current-state-retrieval-design.md`。
