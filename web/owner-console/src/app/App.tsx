    ...
    <AutoRefreshProvider>
      <Routes>
        <Route element={<AppShell />}>
          ...
          />
          <Route path="/owner-console/tasks" element={<TasksPage />} />
          <Route
            path="/owner-console/tasks/:task_id"
            element={<TaskDetailPage />}
          />
          <Route path="/owner-console/approvals" element={<ApprovalsPage />} />
          <Route
          ...
          />
          <Route path="/owner-console/settings" element={<SettingsPage />} />
